...
- (void)testVerifyWithoutInit
{
    ...
    // Call TSKPinningValidator
    XCTAssertThrows([TSKPinningValidator evaluateTrust:trust forHostname:@"www.good.com"]);

    CFRelease(trust);
}

- (void)testThrowsWithEmptyParameters {

    [TrustKit initializeWithConfiguration:@{kTSKPinnedDomains :
                                                @{@"www.good.com" : @{
                                                          kTSKPublicKeyAlgorithms : @[kTSKAlgorithmRsa4096],
                                                          kTSKPublicKeyHashes : @[@"iQMk4onrJJz/nwW1wCUR0Ycsh3omhbM+PqMEwNof/K0=", // CA Key
                                                                                  @"BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB=", // Fake key
    ...
    XCTAssertEqual([TSKPinningValidator evaluateTrust:trust forHostname:hostname], TSKTrustDecisionShouldBlockConnection);
